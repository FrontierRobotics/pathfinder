...
void lcd_initialize() {
  ...
  serial.print("?G216");   // set display geometry,  2 x 16 characters in this case
  delay(500);                // pause to allow LCD EEPROM to program

  serial.print("?Bff");    // set backlight to ff hex, maximum brightness
  delay(1000);                // pause to allow LCD EEPROM to program

  serial.print("?s6");     // set tabs to six spaces
  delay(1000);               // pause to allow LCD EEPROM to program
  ...
  serial.print("?D11010101010101010");
  delay(300);

  serial.print("?D21818181818181818");
  delay(300);

  serial.print("?D31c1c1c1c1c1c1c1c");
  delay(300);

  serial.print("?D41e1e1e1e1e1e1e1e");
  delay(300);

  serial.print("?D51f1f1f1f1f1f1f1f");
  delay(300);

  serial.print("?D60000000000040E1F");
  delay(300);

  serial.print("?D70000000103070F1F");
  delay(300);
